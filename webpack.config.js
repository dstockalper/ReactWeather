module.exports = {
  entry: './app/app.jsx', // Where webpack starts compiling the bundle file; the first file webpack looks in for required modules and components, and adds them to bundle.js
  output: {
    path: __dirname,
